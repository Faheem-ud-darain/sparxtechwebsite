          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <AnimatedContent direction="up" delay={0.15}>
              <div className="relative group">
                ...
                <div className="absolute -inset-0.5 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-[2rem] blur-xl opacity-0 group-hover:opacity-100 transition duration-1000" />
                
                <div className="relative glass-card p-8 md:p-10 border-white/[0.08] overflow-hidden">
                  {status === 'success' ? (
                    <motion.div 
