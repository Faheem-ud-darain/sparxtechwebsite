        ...
        {!isMobile && SERVICES.length > 6 && (
          <AnimatedContent direction="up" delay={0.2}>
            <div className="mt-16 text-center">
              <Link
                to="/services"
                className="inline-flex group relative px-8 py-4 bg-white/[0.03] border border-white/10 hover:border-green-500/50 rounded-full transition-all duration-500"
              >
